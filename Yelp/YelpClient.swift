...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(term: String, sort: YelpSortMode?, categories: [String]?, radius: Double?, deals: Bool?,  completion: ([Business]!, NSError!) -> Void) -> AFHTTPRequestOperation {
        // For additional parameters, see http://www.yelp.com/developers/documentation/v2/search_api

        // Default the location to San Francisco
        // var parameters: [String : AnyObject] = ["term": term, "ll": "37.785771,-122.406165"]
        // Tumblr 40.7432934,-73.9838792
        var parameters: [String : AnyObject] = ["term": term, "ll": "40.7432934,-73.9838792"]
